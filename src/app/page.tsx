    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 start-1/4 w-[500px] h-[500px] bg-primary/8 rounded-full blur-[120px]" />
          <div className="absolute bottom-0 end-1/4 w-[400px] h-[400px] bg-primary/5 rounded-full blur-[100px]" />
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/login"
              className="w-full sm:w-auto px-8 py-3.5 bg-card hover:bg-card-hover border border-border text-foreground font-semibold rounded-xl text-base transition-colors inline-flex justify-center items-center gap-2"
            >
              {t('hero.login').replace('→', '')} 
      ...
      <section className="py-20 px-4 sm:px-6 border-t border-border/50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-3">{t('pricing.title')}</h2>
            <p className="text-muted max-w-xl mx-auto">
              {t('pricing.subtitle')}
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="bg-card border border-border rounded-2xl p-6 sm:p-8 flex flex-col">
              <h3 className="text-lg font-semibold text-foreground mb-1">{t('pricing.free.title')}</h3>
              <div className="mb-6">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                {[t('pricing.free.f1'), t('pricing.free.f2'), t('pricing.free.f3')].map((item) => (
            ...
            <div className="relative bg-primary/5 border border-primary rounded-2xl p-6 sm:p-8 flex flex-col">
              <span className="absolute -top-3 start-1/2 -translate-x-1/2 rtl:translate-x-1/2 px-3 py-1 bg-primary text-white text-xs font-semibold rounded-full">
                {t('pricing.pro.badge')}
              </span>
              <h3 className="text-lg font-semibold text-foreground mb-1">{t('pricing.pro.title')}</h3>
              <div className="mb-6">
                <span className="text-4xl font-bold text-foreground">{t('pricing.pro.price')}</span>
                <span className="text-muted text-sm">{t('pricing.pro.period')}</span>
              </div>
              <ul className="space-y-3 mb-8 flex-1">
                {[t('pricing.pro.f1'), t('pricing.pro.f2'), t('pricing.pro.f3')].map((item) => (
                  <li key={item} className="flex items-start gap-2.5 text-sm text-muted">
                    <svg className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    </svg>
